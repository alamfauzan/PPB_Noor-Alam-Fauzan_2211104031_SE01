...
import 'package:pertemuan_07/models/product.dart';
import 'package:pertemuan_07/pages/detail.dart';
...
class Mypage extends StatelessWidget {
  ...
  final List<Product> products = [
    Product(
        ...
        lokasi: 'purwokerto',
        deskripsi: 'ini mahal baiknya nabung dulu'),
    Product(
        id: 2,
        nama: 'Keyboard',
        harga: 99999999,
